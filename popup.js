...
function attachHandlers() {
    ...
    //  browser.alarms.clear(alarm.name, function (wasCleared) { console.log(wasCleared); });
...
function showShortcutKeys() {
    if (browser.commands && browserHostType === browser.Chrome) {
        browser.commands.getAll(function(cmd) {
